...
var Polygonal = (function (_super) {
    ...
    Polygonal.prototype.generate = function () {
        ...
        var vertices = this.elevate(delaunay);
        var j = 0;
    ...
    Polygonal.prototype.elevate = function (p) {
        for (var i = 0; i < p.length; i++) {
            var h = this.getRandomArbitrary(this.canvas.width, 0);
            if (!p[i][2]) {
